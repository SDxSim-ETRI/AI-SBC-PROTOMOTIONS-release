...
class PerspectiveViewer(object):
    def __init__(self):
        ...
        _ = rep.create.render_product(
            "/OmniverseKit_Persp", resolution=(1920, 1080)
        )

        # Inference-mode rendering: disable expensive effects, keep AO for visual quality
        self.configure_inference_rendering()

    def configure_inference_rendering(self):
