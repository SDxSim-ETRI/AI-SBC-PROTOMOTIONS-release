...
class NewtonSimulatorConfig(SimulatorConfig):
    ...
    camera_offset: Optional[List[float]] = field(
        default=None,
        metadata={
            "help": (
                "Initial camera offset [x, y, z] from character root. "
                "Default: [0, -5, 1] (side/rear view). "
                "To view from behind: [0, 5, 1]. To view from right: [5, 0, 1]."
            )
        },
    )
