...
@dataclass
class EtriSuitRobotConfig(RobotConfig):
    """
    Biomechanical human skeleton + ETRI exoskeleton suit with 35 DOFs (31 skeleton + 4 cables).
    28 bodies (world excluded).

    8 new skeleton joints (subtalar_r/l, mtp_r/l, wrist_flex_r/l, wrist_dev_r/l) are locked
    ...
    See mjcf/31dof/skeleton_torque_suit.xml for full definition.
    """
    ...
    #   여러 mimic 실험이 공유하므로 특정 실험 폴더가 아니라 계열 루트에 둔다.
            ...
            asset_file_name="mjcf/31dof/skeleton_torque_suit.xml",
