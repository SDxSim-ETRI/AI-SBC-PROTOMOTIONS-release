# test-motion-loop1200-tall — 체형별 레퍼런스 모션
...
|---|---|
| betas[0] | +1.0 |
| 골격 XML | `/home/user/PM_Tasks/tasks_for_smpl/mimic_smpl/data/assets/mjcf_newton_exosuitHS/smpl_humanoid_exosuitHS_for_train_tall.xml` |
| 총질량 (슈트 4.700 kg 포함) | 78.6990 kg |
| 대퇴 / 정강 / 다리합 | 397.1 / 427.3 / 824.5 mm |
| 발바닥 중앙 (자기 XML 기준) | **+9.4 mm**, frame0 접지 ±0.0 mm |
...
X=/home/user/PM_Tasks/tasks_for_smpl/mimic_smpl/data/assets/mjcf_newton_exosuitHS/smpl_humanoid_exosuitHS_for_train_tall.xml
...
SRC_XML=$A/mjcf_newton_exosuitHS/smpl_humanoid_exosuitHS_for_train_v2.xml \
  $PY tasks_for_smpl/script/make_exosuit_betas.py hs tall +1.0
...
```bash
MOTION=.../motions/test-motion-loop1200-tall/loop1200_3motions.yaml
```
