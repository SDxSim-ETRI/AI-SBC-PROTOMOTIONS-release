# test-motion-loop1200-short — 체형별 레퍼런스 모션
...
|---|---|
| betas[0] | -1.0 |
| 골격 XML | `/home/user/PM_Tasks/tasks_for_smpl/mimic_smpl/data/assets/mjcf_newton_exosuitHS/smpl_humanoid_exosuitHS_for_train_short.xml` |
| 총질량 (슈트 4.700 kg 포함) | 58.7422 kg |
| 대퇴 / 정강 / 다리합 | 356.4 / 373.8 / 730.3 mm |
| 발바닥 중앙 (자기 XML 기준) | **+10.7 mm**, frame0 접지 ±0.0 mm |
...
X=/home/user/PM_Tasks/tasks_for_smpl/mimic_smpl/data/assets/mjcf_newton_exosuitHS/smpl_humanoid_exosuitHS_for_train_short.xml
...
SRC_XML=$A/mjcf_newton_exosuitHS/smpl_humanoid_exosuitHS_for_train_v2.xml \
  $PY tasks_for_smpl/script/make_exosuit_betas.py hs short -1.0
...
```bash
MOTION=.../motions/test-motion-loop1200-short/loop1200_3motions.yaml
```
